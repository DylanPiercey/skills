...
<!-- Repo-specific guidance for filing and triage. Keep dense. Suggested topics:
- how to reproduce claims (compile/run/test commands)
- guard-test conventions (where tests live, snapshot commands, fixture patterns)
- pre-ship checks (build, size, lint)
